...
<?php 
    ...
    if (isset($_GET['id'])) {
        ...
        $uemail = $rows['EMAIL'];
        $carprice = $email['PRICE']; // Fixed $_email to $email
        ...
        if (isset($_POST['book'])) {
            ...
            $rdate = date('Y-m-d', strtotime($bdate) + (24 * 3600 * $dur));
    ...
    ?>
       ...
       <div class="hai">
        ...
        <form id="register" method="POST"  >
            ...
            id="datefield"  default=date placeholder="ENTER THE DATE FOR BOOKING">
            <br><br>
